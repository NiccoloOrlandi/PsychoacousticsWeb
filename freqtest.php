...
<div class="container">
    <div class="row justify-content-center align-items-center">
        ...
        <div class="col-12 col-md-5 bg-light p-5 rounded-4 border mt-5" id="PlayForm" style="display: none">
            <div class="row gy-3 justify-content-between align-items-center">
                <h2 class="col-12 text-center mb-3" id="answerPuretonefrequencydiscrimination">Which is the highest pitch tone?</h2>
                <?php
    ...
    <button type="button" class="btn btn-outline-secondary btn-lg rounded-4 position-fixed bottom-0 end-0 m-5"
            id="downloadData" onclick="downloadData('freq')" style="display: none" disabled>
